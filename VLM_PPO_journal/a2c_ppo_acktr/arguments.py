...
def get_args():
    ...
    parser.add_argument(
        '--utkinect-root',
        type=str,
        default='../utkinect/utkinect',
        help='root directory for the UTKinect dataset')
    parser.add_argument(
        '--utkinect-split',
        type=str,
        default='train',
        choices=['train', 'val', 'test'],
        help='dataset split for UTKinect')
    parser.add_argument(
        '--utkinect-history',
        type=int,
        default=6,
        help='number of previous action labels to include in the UTKinect prompt')
    parser.add_argument(
        '--utkinect-frame-skip',
        type=int,
        default=1,
        help='how many annotated frames to skip when advancing through UTKinect sequences')
    parser.add_argument(
        '--save-dir',
