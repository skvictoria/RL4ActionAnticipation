...
from utkinects_env import UtkinectsEnv 
...
def make_env(env_id, seed, rank, log_dir, allow_early_resets, use_cnn=True, dataset_path=''):
    def _thunk():
...
def make_vec_envs(env_name,
                  ...
                  use_cnn=False, dataset_path=''):
    envs = [
        make_env(env_name, seed, i, log_dir, allow_early_resets, use_cnn, dataset_path)
